...
<View style={styles.formContainer}>
  ...
  <Text>Trouvez facilement votre chemin vers notre pharmacie grace a notre carte interactive. Obtenez des indications precises et decouvrez les services que nous proposons. N'hésitez pas à nous rendre visite pour tous vos besoins en matière de santé et de bien-être.</Text>
</View>
  ...
  <View style={styles.modalContent}>
    ...
    <Text style={styles.address}>{selectedPharmacy.address}</Text>
              ...
              <Text style={styles.modalText}>Numéros de téléphone :</Text>
              {dialogPhoneNumbers}
